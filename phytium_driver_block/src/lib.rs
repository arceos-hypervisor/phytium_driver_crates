...
pub use phytium_mci::{sd::SdCard, set_impl, IoPad, Kernel, PAD_ADDRESS};
...
fn deal_mci_host_err(err: MCIHostError) -> io::Error {
    let kind = match err {
        ...
        MCIHostError::AllSendCidFailed | MCIHostError::SendRelativeAddressFailed | 
        MCIHostError::SendCsdFailed | MCIHostError::SelectCardFailed | 
        MCIHostError::SendScrFailed => {
            io::ErrorKind::InvalidParameter { name: "card_command" }
        }
        ...
        MCIHostError::StopTransmissionFailed | MCIHostError::WaitWriteCompleteFailed => {
            io::ErrorKind::InvalidParameter { name: "transmission" }
        }
        MCIHostError::InvalidVoltage | MCIHostError::SwitchVoltageFail | 
        MCIHostError::SwitchVoltage18VFail33VSuccess => {
            io::ErrorKind::InvalidParameter { name: "voltage" }
        }
        MCIHostError::SdioResponseError | MCIHostError::SdioInvalidArgument | 
        MCIHostError::SdioSendOperationConditionFail | MCIHostError::SdioSwitchHighSpeedFail |
        MCIHostError::SdioReadCISFail | MCIHostError::SdioInvalidCard => {
            io::ErrorKind::InvalidParameter { name: "sdio" }
        }
        ...
        MCIHostError::CardDetectFailed | MCIHostError::CardInitFailed => {
            io::ErrorKind::InvalidParameter { name: "card_detect" }
        }
        ...
        MCIHostError::PollingCardIdleFailed | MCIHostError::DeselectCardFailed => {
            io::ErrorKind::InvalidParameter { name: "card_control" }
        }
